...
import { INFINITY } from "./helpers/config.mjs";
...
Hooks.once('init', async function() {
  ...
  Actors.registerSheet("infinity", InfinityActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("infinity", InfinityItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.infinity.rollItemMacro("${item.name}");`;
